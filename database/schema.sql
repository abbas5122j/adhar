...
CREATE TABLE update_history (
  ...
  approved_by UUID, -- UIDAI staff ID
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE INDEX idx_fraud_user_created ON fraud_logs(user_id, created_at);
CREATE INDEX idx_fraud_risk_created ON fraud_logs(risk_level, created_at);
...
-- ============================================================================
-- TRIGGERS (Optional, for audit trail auto-update)
-- ============================================================================
...
-- Auto-update `updated_at` timestamp on appointments table
CREATE TRIGGER update_appointments_updated_at
BEFORE UPDATE ON appointments
FOR EACH ROW
SET NEW.updated_at = CURRENT_TIMESTAMP;

-- Auto-update `updated_at` timestamp on update_history table
CREATE TRIGGER update_history_updated_at
BEFORE UPDATE ON update_history
FOR EACH ROW
SET NEW.updated_at = CURRENT_TIMESTAMP;
